...
### 📈 시퀀스 다이어그램
WatchDucks 서비스 구성요소의 동작 흐름을 나타내는 UML Sequence Diagram입니다. 메트릭 확인용 콘솔 서버는 제외하였습니다.

![image](https://github.com/user-attachments/assets/69c5444f-c4e0-4639-afb2-892e57170961)
